#!/usr/bin/env python3
"""
Update the Priority Roofing parallel campaign to target phone calls specifically.
"""
import sys
...
def update_campaign_for_phone_calls(customer_id: str, campaign_resource_name: str):
    ...
    try:
        ...
        print("New bidding strategy: TARGET_CPA ($50 per phone call)")
        return True
...
def main():
    ...
    if success:
        ...
        print("  - Conversion tracking: Ready for your 'Manual Dial MS' action")
    else:
