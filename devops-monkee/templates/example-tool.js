...
exports.ExampleFileProcessor = void 0;
var devops_monkee_1 = require("devops-monkee");
/**
 * Example: Custom file processor tool
 *
 * This demonstrates the pattern for creating shareable tools
 */
var ExampleFileProcessor = /** @class */ (function () {
    function ExampleFileProcessor() {
    }
    /**
     * Process a file safely using shared utilities
     */
    ExampleFileProcessor.prototype.processFile = function (filePath, baseDir) {
        return __awaiter(this, void 0, void 0, function () {
            var safePath;
            return __generator(this, function (_a) {
                safePath = (0, devops_monkee_1.validatePath)(filePath, baseDir);
                // Your custom logic here
                // ...
                return [2 /*return*/, safePath];
            });
        });
    };
    /**
     ...
     */
    ExampleFileProcessor.prototype.logSafely = function (message) {
        // Use shared log sanitization utility
        var safeMessage = (0, devops_monkee_1.sanitizeLog)(message);
        console.log(safeMessage);
    };
    return ExampleFileProcessor;
}());
exports.ExampleFileProcessor = ExampleFileProcessor;
/**
 ...
 */
exports.default = ExampleFileProcessor;
